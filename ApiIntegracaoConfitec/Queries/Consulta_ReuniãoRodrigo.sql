...
SELECT B.NUM_SIN,DSC_CAUSA_SIN,DAT_OCOR_SIN,VAL_PAG_SIN 
FROM SPX21250PSQLNEO.YAS_ND.YAS.TAB_SIN_PAG A (NOLOCK)
INNER JOIN SPX21250PSQLNEO.YAS_ND.YAS.TAB_SIN B (NOLOCK)
ON B.NUM_APOL = A.NUM_APOL
AND B.NUM_SIN = A.NUM_SIN
WHERE A.NUM_APOL = 1180054267
GROUP BY B.NUM_SIN,DSC_CAUSA_SIN,DAT_OCOR_SIN,VAL_PAG_SIN
