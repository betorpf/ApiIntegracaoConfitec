		...
		*/
		...
		BEGIN
			...
			*/
			...
			IF (@NUM_INSP <> 0)
			BEGIN 
			/*e se o número da Inspeção na TAB_INSP for diferente de zeros */
				/*TODO: ENTENDER*/
				/*
				irá compara os dados da proposta com os dados da inspeção que já existe, 
			...
			*/
			...
			FROM [SPX21250PSQLNEO].YAS_ND.YAS.TAB_PED_COBERT WHERE NUM_APOL = @NUM_APOL --número apólice
