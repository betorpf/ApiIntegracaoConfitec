...
namespace ApiIntegracaoConfitec.Models.Domain.Handler
{
    public class BuscarDadosSolicitarInspecaoRequest
    {
        ...
        [Range(1, Int64.MaxValue, ErrorMessage = "Informe um Número PI maior que zero")]
        ...
        public BuscarDadosSolicitarInspecaoRequest(Int64 Num_PI, int Num_Local, int Tip_Emissao)
        {
            this.Num_PI = Num_PI;
